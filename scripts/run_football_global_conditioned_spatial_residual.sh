...
CONFIG="${CONFIG:-configs/football/dinov3_vitl16_global_conditioned_spatial_residual_raw_16f_hr.yaml}"
INIT_CHECKPOINT="${INIT_CHECKPOINT:-outputs/football_events/vitl16_spatial_attn_residual_multilayer_16f_hr/epoch_3.pt}"
OUTPUT_DIR="${OUTPUT_DIR:-outputs/football_events/vitl16_global_conditioned_spatial_residual_raw_16f_hr}"
...
{
  echo
  echo "===== global-conditioned spatial residual raw-label 16f 640x1120 ====="
  ...
  echo "reference=epoch3 frozen_global frozen_spatial_reader correction=FP_FN_threshold_aligned"
  echo "annotations_dir=/home/new_users/qiuqi/code/football_events_raw"
