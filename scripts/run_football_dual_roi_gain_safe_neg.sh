...
CONFIG="${CONFIG:-configs/football/dinov3_vitl16_dual_roi_gain_safe_neg_16f_hr.yaml}"
INIT_CHECKPOINT="${INIT_CHECKPOINT:-outputs/football_events/vitl16_dual_roi_shared_16f_hr/best.pt}"
OUTPUT_DIR="${OUTPUT_DIR:-outputs/football_events/vitl16_dual_roi_gain_safe_neg_16f_hr}"
...
{
  echo
  echo "===== safe-negative global-conditioned dual-ROI gain experiment ====="
