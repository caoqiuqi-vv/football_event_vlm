...
CONFIG="${CONFIG:-configs/football/dinov3_vitl16_featuremap_structured_roi_temporal_16f_hr.yaml}"
INIT_CHECKPOINT="${INIT_CHECKPOINT:-outputs/football_events/vitl16_featuremap_time_causal_from_fusion_e2_16f_hr/best.pt}"
OUTPUT_DIR="${OUTPUT_DIR:-outputs/football_events/vitl16_featuremap_structured_roi_temporal_16f_hr}"
...
{
  echo
  echo "===== Structured ROI: 3x5 spatial tokens + top4/random2 temporal fusion ====="
