...
OUTPUT_DIR="${OUTPUT_DIR:-outputs/football_events/vitl16_e1_dual_cross_attention_d7b}"
...
{
  echo
  echo "===== D7-B aligned full-to-ROI cross-attention fusion ====="
...
common_args=(
  ...
  "model.view_fusion=dual_cross_attention"
