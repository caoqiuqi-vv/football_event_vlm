...
config_path="${repo_dir}/configs/football/dinov3_vitl16_online_simulation_e13_saliency_rank_from_last6r8.yaml"
output_dir="${repo_dir}/outputs/football_events/vitl16_online_simulation_e13_saliency_rank_from_last6r8_e1"
