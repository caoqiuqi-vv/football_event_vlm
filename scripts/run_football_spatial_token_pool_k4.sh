...
CONFIG="${CONFIG:-configs/football/dinov3_vitl16_spatial_token_pool_k4_16f_hr.yaml}"
INIT_CHECKPOINT="${INIT_CHECKPOINT:-outputs/football_events/vitl16_strong_lora12_mlp_16f_hr_e1/best.pt}"
OUTPUT_DIR="${OUTPUT_DIR:-outputs/football_events/vitl16_spatial_token_pool_k4_16f_hr}"
...
{
  echo
  echo "===== K4 spatial-token pooling: CLS + 4 adaptive local tokens ====="
  ...
  echo "dino_lora_frozen=true spatial_token_pooling=k4 slot_dropout=0.1"
