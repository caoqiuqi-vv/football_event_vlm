...
CONFIG="${CONFIG:-configs/football/dinov3_vitl16_clean_negative_margin_raw_16f_hr.yaml}"
INIT_CHECKPOINT="${INIT_CHECKPOINT:-outputs/football_events/vitl16_strong_lora12_mlp_16f_hr_e1/best.pt}"
OUTPUT_DIR="${OUTPUT_DIR:-outputs/football_events/vitl16_clean_negative_margin_raw_16f_hr}"
...
{
  echo
  echo "===== E-SN1 clean-negative margin raw-label 16f 640x1120 ====="
  ...
  echo "clean_negative=safety5s random_pair2 margin1 weight0.25 hard_mining=false"
