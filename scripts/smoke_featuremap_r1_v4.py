#!/usr/bin/env python
"""Verify calibrated event loss directly updates v4 heatmaps."""
...
from train_football_events_featuremap_r1_v4 import (
    load_featuremap_r1_v4,
    load_v4_config,
)
...
def main() -> None:
    ...
    cfg = load_v4_config(args.config, [])
    cfg.gpu_ids = [0]
    cfg.device = "cuda:0"
    ...
    model = load_featuremap_r1_v4(cfg, torch.device(cfg.device))
    model.eval()
