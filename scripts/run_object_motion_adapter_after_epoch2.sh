...
output_dir="${repo_dir}/outputs/football_events/vitl16_d7c_object_motion_dense33_person_from_object_e2_20260902"
...
"${torchrun_bin}" --standalone --nproc-per-node=3 \
  ...
  "model.object_motion.residual_max_delta=1.0" \
  "model.object_motion.gate_init=0.10" \
  "model.object_motion.positive_threshold=0.05" \
  "model.object_motion.negative_weights=[0.02,0.08,0.04]" \
  "model.object_motion.presence_negative_weights=[0.10,0.20,0.50]" \
  ...
  "data.long_video.negative_ratio=2.0" \
  "data.long_video.negative_ratio_by_split.train=2.0" \
  ...
  "train.object_motion_frame_loss_weight=0.50" \
  "train.object_motion_dense_rank_loss_weight=0.15" \
  "train.object_motion_no_evidence_loss_weight=0.05" \
  ...
  "train.curriculum_stages=[{name: object_warmup, start_epoch: 1, end_epoch: 1, overrides: {clip_loss_weight: 0.25, object_motion_frame_loss_weight: 0.10, object_motion_dense_rank_loss_weight: 0.0}}, {name: event_relation, start_epoch: 2, end_epoch: 4, overrides: {clip_loss_weight: 1.0, object_motion_frame_loss_weight: 0.50, object_motion_dense_rank_loss_weight: 0.15}}]" \
