...
config_path="${repo_dir}/configs/football/dinov3_vitl16_online_simulation_e15_tail_sep_lora_from_epoch1best.yaml"
output_dir="${repo_dir}/outputs/football_events/vitl16_online_simulation_e15_tail_sep_lora_from_epoch1best_e1"
