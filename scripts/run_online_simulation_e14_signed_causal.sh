...
config_path="${repo_dir}/configs/football/dinov3_vitl16_online_simulation_e14_signed_causal_continue4.yaml"
output_dir="${repo_dir}/outputs/football_events/vitl16_online_simulation_e14_signed_causal_localgrad_from_last6r8_e1"
