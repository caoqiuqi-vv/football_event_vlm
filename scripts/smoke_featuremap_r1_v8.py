#!/usr/bin/env python
"""Verify competitive-query heatmap gradients and final configuration."""
...
from train_football_events_featuremap_r1_v8 import (
    load_featuremap_r1_v8,
    load_v8_config,
)
...
def main() -> None:
    ...
    model = load_featuremap_r1_v8(cfg, torch.device(cfg.device))
    model.eval()
