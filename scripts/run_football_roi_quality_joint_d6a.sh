...
OUTPUT_DIR="${OUTPUT_DIR:-outputs/football_events/vitl16_e1_dynamic_roi_quality_joint_d6a}"
...
TARGET_GLOBAL_BACKBONE_LR="${TARGET_GLOBAL_BACKBONE_LR:-0.000005}"
...
{
  echo
  echo "===== D6-A learned ROI quality joint fine-tuning ====="
...
common_args=(
  ...
  "model.freeze_global_branch=false"
  ...
  "train.local_loss_weight=0.3"
  "train.frame_det_loss_weight=0.5"
  "train.roi_quality_loss_weight=0.2"
