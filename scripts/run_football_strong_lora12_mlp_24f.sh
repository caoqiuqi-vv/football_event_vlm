...
CONFIG="${CONFIG:-configs/football/dinov3_vitl16_strong_lora12_mlp_24f_512x896_e1.yaml}"
INIT_CHECKPOINT="${INIT_CHECKPOINT:-/mnt/data_16t/football/qiuqi/checkpoints/vitl16_lora_r5_f32_16f_e1_frame_det_last.pt}"
OUTPUT_DIR="${OUTPUT_DIR:-outputs/football_events/vitl16_strong_lora12_mlp_24f_512x896_e1}"
...
{
  echo
  echo "===== B strong single-view LoRA last12+MLP 24f 512x896 ====="
