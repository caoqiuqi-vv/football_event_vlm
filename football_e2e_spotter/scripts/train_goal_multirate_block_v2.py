#!/usr/bin/env python
"""Frame-count-safe multirate block training entrypoint."""
...
from football_e2e_spotter.goal_multirate_data_v2 import SafeMultiRateGoalBlockDataset  # noqa:E402
from football_e2e_spotter.goal_block_loss_v2 import block_retriever_loss_v2  # noqa:E402
class Dataset(SafeMultiRateGoalBlockDataset):
    def __init__(self,*args,**kwargs):super().__init__(*args,motion4_root=extra.motion4_root,pixel_root=extra.pixel_root,**kwargs)
    def __getitem__(self,index):item=super().__getitem__(index);item["motion"]=item["high"];return item
...
if __name__=="__main__":training.GoalBlockDataset=Dataset;training.GoalBlockRetriever=Model;training.block_retriever_loss=block_retriever_loss_v2;training.main()
