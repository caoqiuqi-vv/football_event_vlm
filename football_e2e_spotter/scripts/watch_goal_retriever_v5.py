#!/usr/bin/env python
"""Final v5 watchdog; quality-balanced ranking is the locked experiment."""
...
def run_training_v5() -> None:
    base.OUTPUT.mkdir(parents=True, exist_ok=True)
    log_path = base.EXPERIMENT / "train_retriever_v5.log"
    ...
    command = [
        ...
        str(base.ROOT / "football_e2e_spotter/scripts/train_goal_retriever_v5.py"),
    ...
    with log_path.open("a", encoding="utf-8") as handle:
        ...
        base.update("retriever_training_v5", pid=process.pid, log=str(log_path), output=str(base.OUTPUT))
        code = process.wait()
    if code:
        raise RuntimeError(f"retriever v5 training failed with {code}; see {log_path}")


if __name__ == "__main__":
    base.run_training = run_training_v5
    base.main()
