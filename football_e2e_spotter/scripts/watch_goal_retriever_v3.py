#!/usr/bin/env python
"""v3 watchdog selecting corrected loss and adaptive calibration."""
...
def run_training_v3() -> None:
    base.OUTPUT.mkdir(parents=True, exist_ok=True)
    log_path = base.EXPERIMENT / "train_retriever_v3.log"
    ...
    command = [
        ...
        str(base.ROOT / "football_e2e_spotter/scripts/train_goal_retriever_v3.py"),
    ...
    with log_path.open("a", encoding="utf-8") as handle:
        ...
        base.update("retriever_training_v3", pid=process.pid, log=str(log_path), output=str(base.OUTPUT))
        code = process.wait()
    if code:
        raise RuntimeError(f"retriever v3 training failed with {code}; see {log_path}")


if __name__ == "__main__":
    base.run_training = run_training_v3
    base.main()
