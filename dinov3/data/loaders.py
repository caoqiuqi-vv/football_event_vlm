...
from .datasets import ADE20K, CocoCaptions, FootballSSLWebDataset, FootballVideoFrames, FootballVideoSSL, ImageNet, ImageNet22k, NYU
...
def _parse_dataset_str(dataset_str: str):
    ...
    for token in tokens[1:]:
        ...
        assert key in ("root", "extra", "split", "stride_sec", "edge_sec", "cache_size", "shuffle_buffer")
        kwargs[key] = value
    ...
    elif name == "FootballVideoFrames":
        class_ = FootballVideoFrames
    elif name == "FootballVideoSSL":
        class_ = FootballVideoSSL
    elif name == "FootballSSLWebDataset":
        class_ = FootballSSLWebDataset
    else:
...
def make_dataset(
    *,
    ...
    try:
        ...
        logger.info("dataset is an infinite iterable stream")
